...
GET https://{$abs_get_acc_stmt_dt_url}?dep_id=555&id=666&iban=KZ000000000000000000&dt=2020-01-01
...
.. list-table:: Описание полей
   ...
   * - Поле
     - Описание
   * - dep_id/id
     - DEP_ID/ID договора. Предается только для АБС колвир
   * - iban
     - Предается только для договоров Way4
   * - dt
